#!/usr/bin/env python
"""
Package metadata for list_courses.
"""
import os
import re
import sys
...
VERSION = get_version('list_courses', '__init__.py')
...
setup(
    ...
    author='Ali Tariq',
    author_email='ali.tariq@arbisoft.com',
    url='https://github.com/valkrypton/list_courses',
    packages=find_packages(
        include=['list_courses', 'list_courses.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "list_courses = list_courses.apps:ListCoursesConfig",
        ]
    }
)
