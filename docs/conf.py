...
"""
list_courses documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'list_courses',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/arbisoft/list_courses",
...
#
# html_title = 'list_courses v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'list_courses'),
                os.path.join(root_path, 'list_courses/migrations')])
